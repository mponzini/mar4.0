...
merged_summary_df$`Estimate (SE) 2` = c(formatted_summary_df$`Estimate (SE)`,rep("",4))
merged_summary_df$`P-Value 2` = c(formatted_summary_df$`P-Value` ,rep("",4))
```
...
merged_summary_df$`Estimate (SE) 3` = c(formatted_summary_df$`Estimate (SE)`,rep("",5))
merged_summary_df$`P-Value 3` = c(formatted_summary_df$`P-Value` ,rep("",5))
```
